...
# -------------------------
# PAUSE MENU BUTTONS (fixed positions, mouse-clickable)
BUTTON_WIDTH = 260
BUTTON_HEIGHT = 60
...
# -------------------------
# GAME STATE & SPEEDRUN
game_state = "menu"  # menu, playing, paused, enter_username, scoreboard, tutorial
geysers = []
...
while running:
    ...
    if game_state == "menu":
        ...
        tutorial_text = font.render("Press T for How to Play", True, (0, 200, 255))
        screen.blit(title, (SCREEN_WIDTH // 2 - 200, SCREEN_HEIGHT // 2 - 140))
        screen.blit(start_text, (SCREEN_WIDTH // 2 - 250, SCREEN_HEIGHT // 2 - 20))
        screen.blit(speedrun_text, (SCREEN_WIDTH // 2 - 300, SCREEN_HEIGHT // 2 + 60))
        screen.blit(tutorial_text, (SCREEN_WIDTH // 2 - 260, SCREEN_HEIGHT // 2 + 140))
    ...
    if game_state == "victory":
        ...
        win_title = font.render("Boss Defeated!", True, (255, 215, 0))
        ...
        congrats = small_font.render("You made it through all the levels and defeated the dragon boss.", True, (200, 200, 200))
        ...
        hint = small_font.render("Press ENTER or click Main Menu to continue", True, (180, 180, 180))
    ...
    if game_state == "tutorial":
        ...
        controls_list = [
            ...
            "F              -  Punch (attack enemies in front of you)",
            "ESC            -  Pause / Resume game",
            "6              -  Dev teleport to level 6",
        ]
        ...
        enemies_list = [
            ...
            "Touching an enemy deals 1 damage to you.",
            "Punch (F) an enemy to damage it - each hit removes 1 of its 3 health.",
            "An enemy is defeated once its health bar reaches zero.",
            "Watch the small health bar above each enemy to see how close it is to dying.",
        ]
        ...
        if punching and punch_rect and punch_rect.colliderect(boss_rect):
            ...
            if boss["health"] <= 0:
                ...
                if speedrun_mode and timer_start is not None:
                    ...
                    # Normal mode: show a victory screen
                    boss = None
                    game_state = "victory"
