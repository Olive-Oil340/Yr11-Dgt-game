...
characterWalking_img = pygame.image.load("character v2 walking.png")
characterwalking_img = pygame.image.load("character v2 walking walking.png")
menuscreen_img = pygame.image.load("Menu screen.png")
Fragments_img = pygame.image.load("Fragments.png")
...
def build_level(level_map):
    ...
    a list of platform rects, a list of enemy dicts, and a boss dict
    (or None if this level has no boss)."""
    platforms = []
    enemies = []
    boss = None
...
# -------------------------
game_state = "menu"  # menu, playing, paused, enter_username, scoreboard, tutorial, victory
boss_projectiles = []
boss_hazards = []
